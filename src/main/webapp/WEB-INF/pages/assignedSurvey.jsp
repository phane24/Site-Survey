...
<head>
	...
	<script>
		...
		{			
			$.ajax({
               type:"get",
               url:"getAssignedSurveySites",
               contentType: 'application/json',
               datatype : "json",
               success:function(data) {
                   assignedSurveyList = JSON.parse(data);
					
                   for(var i=0;i<assignedSurveyList.length;i++)
        		   {					
                   	dataSet.push([assignedSurveyList[i].siteid,assignedSurveyList[i].surveyStatus]);
  
        		   }
                  
                   
			 var table1=$('#assignedSitesTable').DataTable({
					destroy:true,
					language: {
				...
				<div class="page-inner">
					...
					<div class="row">
						<div class="col-sm-6 col-md-3">
							...
							<div class="card-body" onclick="location.href='${pageContext.request.contextPath}/assignedSurvey'"	style="border-radius: 10px;background-color:#00B1BF;cursor: pointer;" id="assginedSites">
									<div class="row align-items-center">
										...
										<div class="col col-stats ml-3 ml-sm-0">
											<div class="numbers">
												...
												<h4 class="card-title" style="color:#ffffff;" id="assignedSurvey" ></h4>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="assignedSitesTable" style="width:100%" class="display table table-striped table-hover" ></table>
									</div>
								</div>
							</div>
						</div>
