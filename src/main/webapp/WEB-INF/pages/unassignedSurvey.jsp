...
<head>
	...
	<script>
		...
		{			
			$.ajax({
               type:"get",
               url:"getUnAssignedSurveySites",
               contentType: 'application/json',
               datatype : "json",
               success:function(data) {
                   unAssignedSurveyList = JSON.parse(data);
					
                   for(var i=0;i<unAssignedSurveyList.length;i++)
        		   {
					
                   	dataSet.push([unAssignedSurveyList[i].siteid,unAssignedSurveyList[i].surveyStatus]);
  
        		   }
                  
                   
			 var table1=$('#unassignedSitesTable').DataTable({
					destroy:true,
					language: {
			...
			<div class="content">
				<div class="page-inner">
					...
					<div class="row">
						...
						<div class="col-sm-6 col-md-3">
							<div class="card card-stats card-round">
								<div class="card-body" onclick="location.href='${pageContext.request.contextPath}/unassignedSurvey'" style="border-radius: 10px;background-color:#00B1BF;cursor:pointer;">
									<div class="row align-items-center">
										<div class="col-icon">
										...
										<div class="col col-stats ml-3 ml-sm-0">
											<div class="numbers">
												...
												<h4 class="card-title"  style="color:#ffffff;" id="unassignedSurvey" ></h4>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="row align-items-center">
										...
										<div class="col col-stats ml-3 ml-sm-0">
											<div class="numbers">
												...
												<h4 class="card-title"  id="closedSurvey" ></h4>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="unassignedSitesTable" style="width:100%" class="display table table-striped table-hover" ></table>
									</div>
								</div>
							</div>
						</div>
